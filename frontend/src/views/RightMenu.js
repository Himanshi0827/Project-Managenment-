...
//                                   Requirement id:
//                                 </label>
//                                 <input  name="requirement.requirementNumber"></input>
//                                 <label className="block text-blueGray-600 text-sm font-bold mb-2">
//                                   Enter your query:
//                                 </label>
//                                 <textarea
...
const RightMenu = ({ closeRightMenu, setContent }) => {
  ...
  return (
    <div style={sidebarStyle} id="rightMenu">
      <button onClick={closeRightMenu} style={buttonStyle}>
        &times;
      </button>
      <button
        onClick={toggleQueryForm}
        style={linkStyle2}
        className="bg-blueGray-800 ml-4 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mt-4 ease-linear transition-all duration-150 mb-3 ml-4"
      >
        Create Query
      </button>
      {/* <a onClick={() => setContent('Aim')} style={linkStyle}>Our Aim</a>
      ...
      {queryForms["123"] && ( // Conditional rendering based on state
        <form
          onSubmit={(e) => handleQueryFormSubmit(e, "123")}
          className="mt-4 bg-blueGray-50 p-4 rounded shadow-inner"
          style={linkStyle2}
        >
          <div className="form-group mb-4">
