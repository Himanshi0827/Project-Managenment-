...
const paginate = (pageNumber) => setCurrentPage(pageNumber);
    ...
    <div className="bg-blueGray-100 min-h-screen p-6 font-sans px-3 py-3">
      ...
      {showForm && (
        ...
        <div
                  ...
                  >
          <h1 className="text-blueGray-600 text-xl font-bold mb-1 text-center">Create New Project</h1>
          <form onSubmit={handleCreateProject}className="mt-4 bg-blueGray-50 p-4 rounded shadow-inner"
                      style={{ borderRadius: "30px" }}>
            <div className="mb-4">
              <label className="block text-blueGray-600">Project Number</label>
              <input
                type="number"
                name="projectNumber"
  ...
  <option value="Waiting">Waiting</option>
            ...
            <div className="mb-4">
              <label className="block text-blueGray-600">Date of Creation</label>
              <input
                type="date"
                name="dateOfCreation"
