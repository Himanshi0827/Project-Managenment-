...
//     const formMetadata = btoa(unescape(encodeURIComponent(JSON.stringify({ title, description, data }))));
...
//                   children: [
//                     new TextRun({
//                       text: item.value || (item.date ? item.date.toString().slice(0, 10) : "") || "",
//                       size: 28,
//                     }),
//                   ],
//                   spacing: {
...
//     }
//   };
//   const UploadFileInput = ({ handleFileUpload }) => {
//     return (
//       <input
//         type="file"
//         accept=".docx"
...
//     );
//   };
//   // Ensure you have the mammoth package installed
...
//       try {
//         const decodedMetadata = decodeURIComponent(escape(atob(metadataMatch[1])));
...
//   //   // Find the JSON string within the text content
...
//   //     } catch (error) {
//   //       console.error("Error parsing JSON from DOCX", error);
//   //       return null;
//   //     }
//   //   }
